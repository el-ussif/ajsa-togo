    ...
    <div class="">
        ...
        <div class="bg-white rounded-lg shadow-xl w-full mx-auto mt-6">
            ...
            <div class="flex justify-between items-center p-6 border-b">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Détails du post</h2>
                    <p class="text-gray-600">Informations complètes sur ce post</p>
                </div>
                    ...
                    <div id="deleteModal{{ $post->id }}" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
                        <div class="bg-white rounded-lg shadow-lg w-full max-w-md">
                            <form method="POST" action="{{ route('posts.destroy', $post) }}">
                                ...
                                <div class="p-6">
                                    <p>Êtes-vous sûr de vouloir supprimer le post <strong>{{ $post->title }}</strong> ?</p>
                                </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-8 border border-gray-200 p-6 rounded-lg bg-white">
                    ...
                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Titre :</p>
                        <div class="bg-gray-100 p-3 rounded-md">{{ $post->title }}</div>
                    </div>

                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Résumé :</p>
                        <div class="bg-gray-100 p-3 rounded-md">{{ $post->summary }}</div>
                    </div>

                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Contenu :</p>
                        <div class="bg-gray-100 p-3 rounded-md prose">{!! nl2br(e($post->content)) !!}</div>
                    </div>

                    @if($post->cover_image)
                        <div class="mb-4">
                            <p class="font-medium text-gray-700 mb-1">Image de couverture :</p>
                    ...
                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Type de contenu :</p>
                        <div class="bg-gray-100 p-3 rounded-md">{{ $post->content_type }}</div>
                    </div>

                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Catégorie :</p>
                        <div class="bg-gray-100 p-3 rounded-md">{{ $post->category->name }}</div>
                    </div>

                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Auteur :</p>
                        <div class="bg-gray-100 p-3 rounded-md">{{ $post->author->name }}</div>
                    </div>

                    @if($post->donate_link)
                        <div class="mb-4">
                            <p class="font-medium text-gray-700 mb-1">Lien de donation :</p>
                            <div class="bg-gray-100 p-3 rounded-md">
                                <a href="{{ $post->donate_link }}" target="_blank" class="text-blue-600 underline">
                                    {{ $post->donate_link }}
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Mise en avant :</p>
                        <div class="bg-gray-100 p-3 rounded-md">
                            {{ $post->highlighting ? 'Oui' : 'Non' }}
                        </div>
                    </div>

                    <div class="mb-4">
                        <p class="font-medium text-gray-700 mb-1">Publié le :</p>
                        <div class="bg-gray-100 p-3 rounded-md">
                            {{ $post->published_at ? $post->published_at->format('d/m/Y à H:i') : 'Non publié' }}
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 p-6 rounded-lg bg-white">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="bg-gray-100 p-3 rounded-md">
                            {{ $post->created_at->format('d/m/Y à H:i:s') }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-100 p-3 rounded-md">
                            {{ $post->updated_at->format('d/m/Y à H:i:s') }}
                        </div>
                    </div>
                </div>
            </div>
