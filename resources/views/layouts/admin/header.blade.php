...
>
    ...
    >
        ...
        >
            <div class="2xsm:gap-3 flex items-center hidden gap-2">
                <!-- Dark Mode Toggler -->
                <button
            ...
            >
              ...
              ></span>
                    ...
                    <div
                        x-show="dropdownOpen"
                        class="shadow-theme-lg hidden absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0"
                    >
                        <div
                  ...
                  >
                    <img
                        src="/images/offices/user/user-02.jpg"
                        alt="User"
                  ...
                  >
                    <img
                        src="/images/offices/user/user-03.jpg"
                        alt="User"
                        class="overflow-hidden rounded-full"
                    />
                    <span
                  ...
                  >
                    <img
                        src="/images/offices/user/user-04.jpg"
                        alt="User"
                        class="overflow-hidden rounded-full"
                    />
                    <span
                  ...
                  >
                    <img
                        src="/images/offices/user/user-05.jpg"
                        alt="User"
                        class="overflow-hidden rounded-full"
                    />
                    <span
        ...
        <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="{{ asset('/images/offices/user/owner.jpg') }}" alt="User" />
        </span>
                    ...
                    <svg
                        ...
                        class="stroke-gray-500 transition-transform duration-200"
                        width="18"
                        height="20"
                        viewBox="0 0 18 20"
                        fill="none"
                ...
                <div
                    x-show="dropdownOpen"
                    x-transition
                    class="shadow-theme-lg absolute right-0 mt-4 w-64 flex-col rounded-2xl border border-gray-200 bg-white p-3 z-50"
                >
                    <!-- User Info -->
                    <div>
                 ...
                 {{ Auth::user()->email }}
                    ...
                    <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3">
                        <li>
                            <a
                                href="#"
                                class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100"
                            >
                                <svg
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button
                            type="submit"
                            class="group w-full text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100"
                        >
                            <svg
                                class="fill-gray-500 group-hover:fill-gray-700"
                                width="24"
                            ...
                            >
                                <path
                                    d="M16 13v-2H7V8l-5 4 5 4v-3h9zM20 3h-8v2h8v14h-8v2h8c1.1 0
                        2-.9 2-2V5c0-1.1-.9-2-2-2z"
                                    fill="currentColor"
                                />
                            </svg>
                            Déconnexion
